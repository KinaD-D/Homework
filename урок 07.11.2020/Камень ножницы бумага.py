def function(YourChoice, BotChoice, wins, raza, kamen, bumaga, scissors, Game):
	for i in range(Game):
...
BotChoice = YourChoice = scissors = bumaga = kamen = raza = wins = x = 0 
import random
while x == 0:
	...
	print(function(YourChoice, BotChoice, wins, raza, kamen, bumaga, scissors, Game))
	x = input('Хотите повторить? введите 0 - если да, 1 если нет')